...
The instructions below pertain to creating an EKS cluster **only if** you are not using Capacity Blocks. If you are using Capacity Blocks, please check out the [Capacity Blocks](capacity-blocks) section below.
